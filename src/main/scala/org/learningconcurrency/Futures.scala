...
object FutureDemo extends App {
	val firstOccurrence: Future[Iterator[String]] = Future {
		val bufSource = Source.fromFile("/home/vitalis/README.txt")
		val seq = bufSource.getLines()
		seq
	}

	firstOccurrence foreach {
		strings =>
			for (str <- strings) println(str.toUpperCase)
	}
}

object FileIO extends App {
	val file = "/home/vitalis/README.txt"
